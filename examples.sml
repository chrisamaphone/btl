...
struct
  ...
  *)
  ...
  fun test_step_iter e = 
    step_iter e init_state1 door_bot_rules
  (* testing step_iter:
  *
  * test_step_iter (get_through_door bot1);
  *
  * *)

  val two_bots = [get_through_door bot1, get_through_door bot2]

  fun test_par_iter es =
    step_par_iter es init2bots door_bot_rules

  (* testing step_par_iter:
  *
  *   test_par_iter two_bots
  *
  *)
